...
const QuickStart = () => {
    ...
    return (
        <section id="quick-start" className="py-20 bg-slate-800/50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {steps.map((step, index) => (
                        <div key={index} className="bg-slate-900 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-slate-800">
                            ...
                            <div className="bg-slate-950 rounded-lg p-4 font-mono text-sm text-slate-300 overflow-x-auto max-w-full">
